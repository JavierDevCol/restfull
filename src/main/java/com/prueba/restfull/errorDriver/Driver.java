...
public class Driver extends ResponseEntityExceptionHandler {
    ...
    public Driver() {
        CODIGOS_ESTADO.put(ExceptionNotFindObj.class.getSimpleName(), HttpStatus.NOT_FOUND.value());
        CODIGOS_ESTADO.put(ExceptionObjectDupliucate.class.getSimpleName(), HttpStatus.CONFLICT.value());
